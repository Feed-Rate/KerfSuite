# KerfCut — Codebase Review & Development Roadmap
>
...
- [ ] Spin up dedicated **Supabase instance** for KerfCut (separate from SoulLink)
...
**Competitive positioning:** Z-CAD is the acknowledged incumbent — German, aging, hard to find. KerfCut's pitch writes itself.
...
**Pricing framing:** Don't sell features — sell material savings. If KerfCut saves one sheet of 18mm MDF per job, it's paid for itself. Frame the pitch around that.
